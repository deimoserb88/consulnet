...
<head>
    ...
    <title>[ConsulNet] Modulo de administración</title>
        ...
        <div class="container" style="width: 100%;">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="{{ url('/consultas') }}"><i class="fa fa-btn fa-stethoscope"></i>Consultas</a></li>
                    <li><a href="{{ url('/pacientes') }}"><i class="fa fa-btn fa-users"></i>Pacientes</a></li>
                    <li><a href="{{ url('/medicos') }}"><i class="fa fa-btn fa-user-md"></i>Medicos</a></li>
                    <li><a href="{{ url('/especialidades') }}"><i class="fa fa-btn fa-heartbeat"></i>Especialidades</a></li>
                    @endif
